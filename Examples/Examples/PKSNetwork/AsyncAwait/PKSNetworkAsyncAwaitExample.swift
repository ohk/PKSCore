//
//  PKSNetworkAsyncAwaitExample.swift
//  Examples
//
...
struct PKSNetworkAsyncAwaitExample: View {
    // Observed ViewModel to update the view when data changes
    @StateObject private var viewModel = PKSNetworkAsyncAwaitViewModel()
    ...
    var body: some View {
        ...
        .navigationTitle("Async/Await Example")
    }
}
